...
const char* ssid       = "iPhone (Alex)";//"uraaple";//"MGTS_70"; //"HUAWEI-E5330-E887";//"iPhone (Alex)";       // Name of the WI-FI
const char* password   = "alexpassword1";//"uramonster123";//"M2F3B9RX";//"hym0ig9q";       // Password for WI-FI
